#!/bin/bash
# Gemini SessionStart hook: Load project context at session start
# Outputs context information that Gemini sees when a session begins
#
# Input schema (SessionStart): No stdin input

echo "=== Gemini Game Studio — Session Context ==="
