...
1. **Read the GEMINI.md** for project overview and standards.

2. **Read the relevant agent definition** from `.agents/subagents/` if a specific
   role is specified.
...
[Summary of conventions relevant to this role from GEMINI.md and agent definition]
